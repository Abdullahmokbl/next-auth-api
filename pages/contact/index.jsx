  ...
  return (
    <div className={`${styles.contact} container navpd`}>
      ...
      <div>
        <h3>Shopping</h3>
        <h3>
          <a href="tel:+201060619338">+20106 061 9338</a>
        </h3>
        <h3>
          <a href="mailto:abdullahmokbl@yahoo.com">abdullahmokbl@yahoo.com</a>
        </h3>
        <p>
          ...
          enquiries please email:<a href="#">abdullahmokbl@yahoo.com</a>
        </p>
        <p>
          Our team at Shopping are always interested in your feedback to do with
        ...
        <p>
          Thank you so much for supporting your local, as well as NZ designers
          and brands! x
        </p>
      </div>
    </div>
